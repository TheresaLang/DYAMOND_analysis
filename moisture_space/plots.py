...
def moisture_space_contourf(fig, ax, x_vector, y_vector, plot_field, num_contours, x_lims, y_lims, x_label, y_label, cb_label, **kwargs):
    
    x, h = np.meshgrid(x_vector, y_vector)
    im = ax.contourf(x, h, plot_field, num_contours, **kwargs)
